...
public class Question4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the progress bar to reflect the fourth question (80%)
        progressBar.setProgress(80);

        TextView questionNumberText = findViewById(R.id.questionNumberText);
        questionNumberText.setText("Question 4/5");
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (selectedId != -1) {
                ...
                // Move to the next question (Question5Activity)
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (langResult == TextToSpeech.LANG_MISSING_DATA || langResult == TextToSpeech.LANG_NOT_SUPPORTED) {
                    Toast.makeText(Question4Activity.this, "Text-to-Speech language not supported", Toast.LENGTH_SHORT).show();
                } else {
                    // Speak the question text when the activity is created
                    textToSpeech.speak("How visible are your pores?", TextToSpeech.QUEUE_FLUSH, null, null);
                }
            } else {
                Toast.makeText(Question4Activity.this, "Text-to-Speech initialization failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
