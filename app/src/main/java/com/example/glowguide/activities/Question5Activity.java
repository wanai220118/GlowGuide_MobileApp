...
public class Question5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the progress bar to reflect the final question (100%)
        progressBar.setProgress(100);

        TextView questionNumberText = findViewById(R.id.questionNumberText);
        questionNumberText.setText("Question 5/5");
        ...
        submitButton.setOnClickListener(v -> {
            ...
            if (selectedId != -1) {
                ...
                // After the last question, navigate to the result screen
                Intent intent = new Intent(Question5Activity.this, SkinTypeResultActivity.class);
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (langResult == TextToSpeech.LANG_MISSING_DATA || langResult == TextToSpeech.LANG_NOT_SUPPORTED) {
                    Toast.makeText(Question5Activity.this, "Text-to-Speech language not supported", Toast.LENGTH_SHORT).show();
                } else {
                    // Speak the question text when the activity is created
                    textToSpeech.speak("Which statement best describes your overall skin concerns?", TextToSpeech.QUEUE_FLUSH, null, null);
                }
            } else {
                Toast.makeText(Question5Activity.this, "Text-to-Speech initialization failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
